...
export const companyScoreDefinitions = [
  {
    ...
    sourceRow: 7,
    rubric: "Peso 9% · 1 ponto por ano de atuação (2016 ou antes = 10).",
  },
  {
  ...
  },
  {
    ...
    sourceSheet: "Avaliacao Empresas",
    sourceRow: 10,
    rubric: "Peso 8% · 1 ponto por ano de formado (2016 ou antes = 10).",
  },
  {
    ...
    sourceSheet: "Avaliacao Empresas",
    sourceRow: 11,
    rubric: "Peso 9% · 10-49=2, 50-100=4, 100-500=6, 500-1000=8, +1000=10.",
  },
  {
  ...
  {
    // Sede física da empresa (Francis 2026-07-11). Peso 8: os 8 pontos foram
    // abertos reduzindo 1 de cada um de 8 critérios maiores (execução 15→14,
    // atuação 10→9, SFV 10→9, manutenção 10→9, CREA 9→8, colação 9→8, prazo
    // assistência 5→4, memorial 5→4) — o grupo Empresa continua fechando 100.
    key: "company.physical_headquarters",
    category: "company",
    section: "A empresa de solar",
    label: "A empresa possui uma sede física",
    defaultEnabled: true,
    maxScore: 10,
    weight: 8,
    sourceSheet: "Avaliacao Empresas",
    sourceRow: 13,
    rubric: "Peso 8% · Sim = 10, Não = 5.",
  },
  {
  ...
  },
  {
    ...
    sourceSheet: "Avaliacao Empresas",
    sourceRow: 15,
    rubric: "Peso 14% · 2 pontos por ano (5+ anos = 10).",
  },
  {
    ...
    sourceSheet: "Avaliacao Empresas",
    sourceRow: 17,
    rubric: "Peso 9% · Sim = 10, 'Sim mas duvido' = 5, Não = 0.",
  },
  {
    ...
    sourceSheet: "Avaliacao Empresas",
    sourceRow: 18,
    rubric: "Peso 4% · 1 dia = 10, cada dia a mais -1 (11+ dias = 0).",
  },
  {
    ...
    sourceSheet: "Avaliacao Empresas",
    sourceRow: 20,
    rubric: "Peso 4% · Sim = 10, 'Sim mas duvido' = 5, Não = 0.",
  },
  {
