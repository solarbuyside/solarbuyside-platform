...
export const initialContent: SectionContent[] = [
    {
            "id": "apoiadores",
            "name": "Apoiadores Institucionais",
            "texts": {
                    "title": "Apoiadores Institucionais Solar Buy-Side",
                    "subtitle": "Empresas referência no mercado solar apoiam o Movimento Solar Buy-Side e contribuem para um novo padrão de profissionalismo, transparência e geração de valor no setor.",
                    ...
                    "logo1Desc": "Distribuidora de equipamentos fotovoltaicos e parceira âncora do movimento Solar Buy-Side.",
                    "logo2Name": "BelEnergy",
                    "logo2Cat": "Fabricantes",
                    "logo2Desc": "Fabrica sistema de fixação de módulo e carregador de veículo elétrico.",
                    "logo3Name": "Clamper",
                    "logo3Cat": "Fabricantes",
                    "logo3Desc": "Fabricante brasileira de dispositivos de proteção contra surtos elétricos.",
                    "logo4Name": "Stäubli",
                    "logo4Cat": "Fabricantes",
                    "logo4Desc": "Fabricante suíça de conectores fotovoltaicos e soluções de conexão elétrica.",
                    "logo5Name": "Longi Solar",
                    "logo5Cat": "Fabricantes",
                    "logo5Desc": "Um dos maiores fabricantes mundiais de módulos fotovoltaicos.",
                    "logo6Name": "Solis",
                    "logo6Cat": "Fabricantes",
                    "logo6Desc": "Fabricante global de inversores solares.",
                    "logo7Name": "Hoymiles",
                    "logo7Cat": "Fabricantes",
                    "logo7Desc": "Fabricante de microinversores e otimizadores para geração distribuída.",
                    "logo8Name": "Fluke",
                    "logo8Cat": "Fabricantes",
                    "logo8Desc": "Fabricante global de instrumentos de medição e diagnóstico elétrico.",
                    "logo9Name": "Huawei",
                    "logo9Cat": "Fabricantes",
                    "logo9Desc": "Fabricante global de inversores e soluções de energia inteligente.",
                    "logo10Name": "Unipower",
                    "logo10Cat": "Fabricantes",
                    "logo10Desc": "Marca UCB Power, fabricante de baterias e soluções de energia.",
                    "logo11Name": "Sil",
                    "logo11Cat": "Fabricantes",
                    "logo11Desc": "Fabricante brasileira de fios e cabos elétricos.",
                    "logo12Name": "Electro Graphics",
                    "logo12Cat": "Tecnologia, Serviços e Seguros",
                    "logo12Desc": "Desenvolvedora do SOLergo, software de projeto e dimensionamento de sistemas fotovoltaicos.",
                    "logo13Name": "SolarView",
                    "logo13Cat": "Tecnologia, Serviços e Seguros",
                    "logo13Desc": "Plataforma de monitoramento de sistemas fotovoltaicos.",
                    "logo14Name": "PV Clean",
                    "logo14Cat": "Tecnologia, Serviços e Seguros",
                    "logo14Desc": "Tecnologia e serviços de limpeza e manutenção de usinas fotovoltaicas.",
                    "logo15Name": "Elétron Seguro Solar",
                    "logo15Cat": "Tecnologia, Serviços e Seguros",
                    "logo15Desc": "Seguros especializados para sistemas de energia solar.",
                    "logo16Name": "Santander",
                    "logo16Cat": "Financiamento Solar",
                    "logo16Desc": "Financiamento para projetos de energia solar.",
                    "logo17Name": "Energy Channel",
                    "logo17Cat": "Mídia Solar",
                    "logo17Desc": "Canal de mídia e conteúdo especializado no setor de energia solar."
            },
            "images": {
                    "logo1Src": "/assets/apoiadores/belenergy.png",
                    "logo2Src": "/assets/apoiadores/belenergy.png",
                    "logo3Src": "/assets/apoiadores/clamper.png",
                    "logo4Src": "/assets/apoiadores/staubli.png",
                    "logo5Src": "/assets/apoiadores/longi.png",
                    "logo6Src": "/assets/apoiadores/solis.png",
                    "logo7Src": "/assets/apoiadores/hoymiles.png",
                    "logo8Src": "/assets/apoiadores/fluke.png",
                    "logo9Src": "/assets/apoiadores/huawei.png",
                    "logo10Src": "/assets/apoiadores/unipower.png",
                    "logo11Src": "/assets/apoiadores/sil.png",
                    "logo12Src": "/assets/apoiadores/solergo.png",
                    "logo13Src": "/assets/apoiadores/solarview.png",
                    "logo14Src": "/assets/apoiadores/pvclean.png",
                    "logo15Src": "/assets/apoiadores/eletron-seguro-solar.png",
                    "logo16Src": "/assets/apoiadores/santander.png",
                    "logo17Src": "/assets/apoiadores/energy-channel.png"
            }
    },
    {
        "id": "manual-strategic",
        ...
        "texts": {
            ...
            "codeDesc1": "Como extensão prática do Manual de Compra Solar Buy-Side, o <span class=\"cms-bold\">Código do Vendedor Consultivo</span> ensina você a pensar como um comprador para conduzir negociações com mais estratégia, segurança e autoridade.",
            "codeDesc2": "Ao aplicar o método, você compreende como o cliente avalia riscos, compara propostas e toma decisões de investimento. Em vez de disputar vendas pelo menor preço, passa a construir valor, conduzir a decisão de compra e posicionar sua proposta como a escolha mais segura.",
            "codeDesc3": "Se o Manual Solar Buy-Side mostra como o comprador decide, o Código do Vendedor Consultivo ensina a transformar esse conhecimento em negociações mais estratégicas, vendas mais lucrativas e clientes mais confiantes.",
            "codeDesc4": "Resultado: você deixa de competir por preço e passa a vender por valor.",
            "codeSubtitle": "O método de imersão no universo Solar Buy-Side para quem não aceita mais perder vendas por preço.",
    ...
    },
    {
        ...
        "images": {
            "promoLogo": "/assets/apoiadores/belenergy.png",
            "pix": "/assets/Pix.png",
