...
create table public.technical_evaluations (
  ...
  distributor_reputation text,
  module_maker_reputation text,
  inverter_maker_reputation text,
...
create table public.financial_evaluations (
  id uuid primary key default gen_random_uuid(),
  comparison_id uuid not null references public.comparisons(id) on delete cascade,
  competitor_id uuid not null,
...
create table public.comparison_score_settings (
  comparison_id uuid not null references public.comparisons(id) on delete cascade,
...
create table public.score_entries (
  ...
  competitor_id uuid not null,
  criterion_key text not null,
  category text not null check (category in ('company', 'technical')),
...
create table public.comparison_result_snapshots (
  id uuid primary key default gen_random_uuid(),
  comparison_id uuid not null references public.comparisons(id) on delete cascade,
...
create table public.comparison_exports (
  id uuid primary key default gen_random_uuid(),
  comparison_id uuid not null references public.comparisons(id) on delete cascade,
...
create table public.comparison_events (
  id uuid primary key default gen_random_uuid(),
  comparison_id uuid not null references public.comparisons(id) on delete cascade,
...
create index comparisons_owner_id_idx on public.comparisons(owner_id);
create index competitors_comparison_id_idx on public.competitors(comparison_id);
create index company_evaluations_comparison_id_idx on public.company_evaluations(comparison_id);
create index technical_evaluations_comparison_id_idx on public.technical_evaluations(comparison_id);
create index financial_evaluations_comparison_id_idx on public.financial_evaluations(comparison_id);
create index score_entries_comparison_id_idx on public.score_entries(comparison_id);
create index comparison_events_comparison_id_created_at_idx
