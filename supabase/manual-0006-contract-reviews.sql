-- =====================================================================
-- Solar Buy-Side — Migration 0006: curadoria de contratos (cole e Run)
-- Idempotente. Guarda análises de contrato e o veredito do usuário.
-- =====================================================================
...
drop policy if exists "contract_reviews_owner_all" on public.contract_reviews;
