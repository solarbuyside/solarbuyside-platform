...
create table if not exists public.technical_evaluations (
  ...
  distributor_score text check (distributor_score in ('ra_1000','otimo','bom','regular','ruim','nao_recomendado','suspensa','em_analise','sem_reputacao')),
  module_maker_name text,
  module_maker_score text check (module_maker_score in ('ra_1000','otimo','bom','regular','ruim','nao_recomendado','suspensa','em_analise','sem_reputacao')),
  inverter_maker_name text,
  inverter_maker_score text check (inverter_maker_score in ('ra_1000','otimo','bom','regular','ruim','nao_recomendado','suspensa','em_analise','sem_reputacao')),
